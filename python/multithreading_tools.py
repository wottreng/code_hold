...
def multitasking(target_function, target_function_args:tuple, number_of_tasks:int, verbose=False):
    # for tick toc timer:
    ...
    for i in range(number_of_tasks):
        p = mp.Process(target=target_function, args=target_function_args)
        job_queue.append(p)
...
if __name__ == '__main__':
    ...
    # time intensive testing function
    ...
    number_of_function_runs = 20  # how many times does this function need to run
    args: tuple = (1,"hello")  # what to pass into function
    multitasking(test_function, args, number_of_function_runs, verbose=True)
