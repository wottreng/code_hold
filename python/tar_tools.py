...
class tarTools:
    ...
    def extractTarFile(self, tarFilename: str, path: str = os.getcwd(), force=False):
    ...
    def createTarFile(self, foldername: str, path: str = os.getcwd()):
    ...
    def appendToTarFile(self, tarFilename: str, files: list, path: str = os.getcwd()):
